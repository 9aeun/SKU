...
<body>
	...
	<div class="jumbotron bg-white">
		<div class="container" style="text-align : center;">
			...
			<br><br><br>
			<h1 class="display-3" style="font-family: 'Hi Melody', cursive;">배송 정보</h1>
		</div>
		<br><br><br>
	...
	<div class="container">
		<form action="./processShippingInfo.jsp" class="form-horizontal" method="post">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="references" type="text" class="form-control" id="sample6_extraAddress" placeholder="참고항목">
