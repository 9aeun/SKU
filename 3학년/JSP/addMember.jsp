...
<script type="text/javascript">
	...
	function inputIdChk(){ //아이디 확인 함수
		var id=document.newMember.id.value;
		if(id.length==0 || id==""){
			alert("아이디를 입력해주세요.");
			document.newMember.id.focus();
		}else{
			window.open("IdCheckForm.jsp","","width=500, height=300");
		}
	}
	
	function inputUdChk(){
		document.userInfo.idDuplocation.value="idUnCheck";
	}
...
<body>
	...
	<div class="jumbotron bg-white">
		<div class="container" style="text-align : center;">
			...
			<br><br><br>
			<h1 class="display-3" style="font-family: 'Hi Melody', cursive;">회원 가입</h1>
		</div>
		<br><br><br>
		...
		<form name="newMember" class="form-horizontal"  action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					...
					<button type="button" onclick="inputIdChk()" name="idCheck" class="checkId">
						중복확인
					</button>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="zipcode" type="text" id="sample6_postcode" placeholder="우편번호" class="form-control">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="detailAddress" type="text" class="form-control" id="sample6_detailAddress" placeholder="상세주소">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-5">
					<input name="reference" type="text" class="form-control" id="sample6_extraAddress" placeholder="참고항목">
